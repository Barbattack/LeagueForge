...
STORE_NAME = "TanaLeague"          # Nome visualizzato nell'app (es. "MioNegozio League")
...
# Su PythonAnywhere: usa path assoluto "/home/username/TanaLeague/tanaleague2/credentials.json"
