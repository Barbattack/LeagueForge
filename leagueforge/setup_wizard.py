...
# -*- coding: utf-8 -*-
"""
LeagueForge - Setup Wizard
==========================

Configurazione interattiva guidata per LeagueForge.
...
def main():
    ...
    print("Benvenuto nel Setup Wizard di LeagueForge!")
    ...
    data["store_name"] = get_input("Nome del tuo negozio/lega", default="LeagueForge")
