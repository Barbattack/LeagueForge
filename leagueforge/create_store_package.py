...
# -*- coding: utf-8 -*-
"""
LeagueForge - Store Package Creator (Franchise Tool)
====================================================
...
OUTPUT:
    packages/LeagueForge_NomeNegozio.zip
"""
...
def create_store_sheet(client, store_name: str, store_email: str) -> str:
    ...
    """
    sheet_title = f"LeagueForge - {store_name}"
...
"""
LeagueForge - Configurazione {store_name}
=========================================
...
def create_package(store_name: str, sheet_id: str, admin_password: str):
    ...
    package_name = f"LeagueForge_{safe_name}"
    ...
    leagueforge_dir = package_dir / "leagueforge2"
    leagueforge_dir.mkdir(parents=True)
    ...
    if creds_src.exists():
        shutil.copy(creds_src, leagueforge_dir / "credentials.json")
    else:
...
chcp 65001 >nul
echo ========================================
echo    LeagueForge - Installazione
echo ========================================
echo.
...
def main():
    ...
    admin_password = input("Password admin per il negozio [default: leagueforge123]: ").strip()
    if not admin_password:
        admin_password = "leagueforge123"
